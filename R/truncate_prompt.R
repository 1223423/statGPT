#' Truncate the code context such that maximum tokens are used
#'
...
truncate_prompt <- \(prompt, CONTEXT_LIMIT, MODEL) {
  ...
  log_debug(paste("Tokenized prompt length:", length(tokenized) + tokens_per_message + overhead_tokens + user_tokens))
